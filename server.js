...
export function createServer() {
  ...
  server.tool(
    ...
    'Save a URL to the link hoard. Fetches title and description automatically.',
    {
      ...
      category: z.enum(['article', 'tool', 'reference', 'video', 'shopping', 'resource', 'thread', 'other'])
        .optional().default('other').describe('Broad content category'),
  ...
  server.tool(
    ...
    'List saved links, optionally filtered by status, category, or tag.',
    {
      ...
      category: z.enum(['article', 'tool', 'reference', 'video', 'shopping', 'resource', 'thread', 'other']).optional(),
